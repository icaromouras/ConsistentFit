...
- **Biblioteca de treinos** — salve treinos padrão divididos em Força (peito, costas, ombro, bíceps, tríceps e membros inferiores), Core, Aeróbico, Mobilidade e **Combinado** (treinos que juntam mais de um grupo muscular). O botão **Montar e salvar treino** monta um treino juntando treinos salvos inteiros, exercícios do catálogo e texto livre e reutilize-os ao agendar. O botão **abrir** mostra o treino salvo em tela cheia.
- **Catálogo de exercícios** — em Treinos → Exercícios, cadastre só o nome (e uma observação de execução, se quiser) por área: membros inferiores, core, peito, ombro, bíceps, tríceps, costas e mobilidade. Comece o nome com o subgrupo entre colchetes (`[Superior] Supino inclinado`) e ele vira uma **seção** dentro da área, com os exercícios em ordem alfabética dentro de cada uma — o colchete some da lista, porque virou o título. Ao agendar, "montar com exercícios" adiciona cada exercício ao treino com um toque — agrupado automaticamente por área (COSTAS, BÍCEPS…) — e você completa séries e repetições no texto. O que já entrou no treino fica **marcado com ✓** na cor da área, com um `×` para tirar sem precisar caçar a linha no texto. A tela cheia mostra o treino formatado, com títulos por grupo e séries alinhadas, e um botão **editar** para o texto livre. Exercícios com observação de execução cadastrada ganham um ⓘ — segure o dedo sobre eles para abrir a explicação.
- **Salvar como treino** — depois de montar um treino ao agendar (por exercícios ou digitando), "salvar como treino" grava aquele texto na Biblioteca com o nome e a categoria que você escolher (já sugerida a partir do grupo muscular usado), pronto para reutilizar em outro dia com "usar treino salvo". O mesmo botão **salvar** também aparece em cada treino já agendado, então dá para guardar como modelo mesmo depois de agendado.
