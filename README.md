...
- **Salvar como treino** — depois de montar um treino ao agendar (por exercícios ou digitando), "salvar como treino" grava aquele texto na Biblioteca com o nome e a categoria que você escolher (já sugerida a partir do grupo muscular usado), pronto para reutilizar em outro dia com "usar treino salvo".
