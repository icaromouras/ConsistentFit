...
- **Biblioteca de treinos** — salve treinos padrão divididos em Aeróbico, Core e Força (peito, costas, ombro, bíceps, tríceps e membros inferiores) e reutilize-os ao agendar. O botão **abrir** mostra o treino salvo em tela cheia.
- **Catálogo de exercícios** — em Treinos → Exercícios, cadastre só o nome (e uma observação de execução, se quiser) por área: membros inferiores, core, peito, ombro, bíceps, tríceps e costas. Ao agendar, "montar com exercícios" adiciona cada exercício ao treino com um toque, e você completa séries e repetições no texto.
