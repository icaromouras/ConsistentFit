...
import type { Agendamento, Dados, DiaInfo, TreinoSalvo } from "./types";
import { C, FONTE, TIPOS, est, tabEst } from "./theme";
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.paper, color: C.ink, fontFamily: FONTE.sans, padding: "18px 16px 48px", maxWidth: 620, margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", marginBottom: 4 }}>
        <h1 style={{ margin: 0, fontSize: 26, fontWeight: 800, letterSpacing: "-0.035em" }}>
